...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.2699;
    ...
    public void setDrivePower(double powerfL, double powerfR, double powerbL, double powerbR){
        motors.get(0).setPower(powerfL);
        motors.get(1).setPower(powerbL);
        motors.get(2).setPower(powerbR);
        motors.get(3).setPower(powerfR);
    }
