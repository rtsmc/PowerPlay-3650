...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.2814; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6.625; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;

    public static double X_MULTIPLIER = 1.0055; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.0138; // Multiplier in the Y direction
